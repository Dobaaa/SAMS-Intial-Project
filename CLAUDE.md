...
- ✅ **F** (DONE, 2026-08-04, `staging` commit `11915d3`) — Removed Commencement Date (A15 appendix row + one clause-4.3 sentence); Time-for-Completion already satisfied "in days" (C08/A16/A17 were already text fields, no work needed there).
