...
FIELDS: list[FieldSeed] = [
    ...
    FieldSeed(TemplateTypeEnum.appendix, "A21", "6.2", "Maximum Liquidated Damages in AED", InputTypeEnum.number, default_value="10", appendix_row_label="Maximum Liquidated Damages", appendix_clause_ref="6.2", show_in_appendix=False, sort_order=21),
