...
FIELDS: list[FieldSeed] = [
    ...
    FieldSeed(TemplateTypeEnum.appendix, "A24", "4.3(b)", "Start of Material Submission", InputTypeEnum.text, appendix_row_label="Start of Material Submission", appendix_clause_ref="4.3(b)", sort_order=19),
    FieldSeed(TemplateTypeEnum.appendix, "A25", "4.3(b)", "Complete all Material Submission", InputTypeEnum.text, appendix_row_label="Complete all Material Submission", appendix_clause_ref="4.3(b)", sort_order=20),
    FieldSeed(TemplateTypeEnum.appendix, "A26", "4.3(b)", "Start of Submission of Shop Drawings", InputTypeEnum.text, appendix_row_label="Start of Submission of Shop Drawings", appendix_clause_ref="4.3(b)", sort_order=21),
    FieldSeed(TemplateTypeEnum.appendix, "A19", "5", "Defects Liability Period", InputTypeEnum.number, auto_source_field_id="C10", appendix_row_label="Defects Liability Period", appendix_clause_ref="5", sort_order=22),
