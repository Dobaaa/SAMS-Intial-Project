...
from models.agreement import Agreement, AgreementClauseRevision, AgreementFieldValue, ClauseRevisionStatus
...
async def get_compare_table(
    ...
    """Simple 3-column Compare view for the GM Portal (req 4): Original
    ...
    Two row sources, both "important admin-entered content" per req 4:
      ...
      - Formal clause revisions (agreement_clause_revisions) — rarer,
        deliberate prose-level edits proposed via the Document view.
