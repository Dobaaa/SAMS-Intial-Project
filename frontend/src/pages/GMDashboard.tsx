/**
 * GM Portal Dashboard — Phase 2 Package B (req 6.1).
 *
 * Restricted view: only agreements pending GM's own approval step, with
 * exactly five columns (Project Code / Agreement Ref / Project Name /
 * Scope of Works / Subcontractor Name) and exactly two actions — View PDF
 * (red-highlighted admin-entered content, Package C) and Compare (the
 * simple 3-column table, Package D). GM's nav points here instead of the
 * general ReviewerDashboard.
 */
